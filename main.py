"""
(DEPRECATED) Legacy desktop OpenCV demo for ErgoSense.

This module is retained temporarily for troubleshooting and will be removed in a future release.

Preferred entrypoint (browser UI):
